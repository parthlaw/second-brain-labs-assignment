...
exports.getMessageResponse = void 0;
var cohere_ai_1 = require("cohere-ai");
var cohere = new cohere_ai_1.CohereClient({
    token: process.env.COHERE_TOKEN
});
var getMessageResponse = function (embeddings, message) { return __awaiter(void 0, void 0, void 0, function () {
    var prompt, resp, err_1;
        ...
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, cohere.chat(({
                        message: prompt,
                        promptTruncation: cohere_ai_1.Cohere.ChatStreamRequestPromptTruncation.Auto,
                        temperature: 0.3
                    }))];
            case 1:
                resp = _a.sent();
